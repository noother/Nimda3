...
class CorePlugin_Botstats extends Plugin {
	...
	function isTriggered() {
		...
		$this->reply(sprintf(
			"\x02Uptime:\x02 %s. \x02Memory:\x02 %.2f MB (%.2f MB max). \x02SQL:\x02 %d queries total (%.2f q/s). \x02Servers:\x02 %d, \x02Channels:\x02 %d, \x02Users:\x02 %d. \x02Jobs:\x02 %d (%d max). \x02Timers:\x02 %d.",
				$uptime,
				$mem_current,
				$mem_peak,
